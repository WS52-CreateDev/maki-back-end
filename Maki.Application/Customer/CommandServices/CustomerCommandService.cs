...
public class CustomerCommandService : ICustomerCommandService
{
    ...
    {
        var customer = _mapper.Map<RegisterCustomerCommand, Domain.Customer.Models.Entities.Customer>(command);
    ...
    public async Task<CustomerResponse> Handle(LoginCustomerCommand command)
    {
        ...
        return _mapper.Map<Domain.Customer.Models.Entities.Customer, CustomerResponse>(customer);
    }
    ...
    public async Task<bool> Handle(UpdateCustomerCommand command)
    {
        ...
        var customer = _mapper.Map<UpdateCustomerCommand, Domain.Customer.Models.Entities.Customer>(command);
