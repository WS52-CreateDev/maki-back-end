...
public class CustomerRepository : ICustomerRepository
{
    ...
    public async Task<Domain.Customer.Models.Queries.Customer> RegisterAsync(
        Domain.Customer.Models.Queries.Customer customer)
    {
    ...
    public async Task<Domain.Customer.Models.Queries.Customer> GetByEmailAndPasswordAsync(string email, string password)
    {
        return await _makiContext.Customers
            .FirstOrDefaultAsync(c => c.Email == email && c.Password == password);
    }

    public async Task<Domain.Customer.Models.Queries.Customer> GetByIdAsync(int id)
    {
        return await _makiContext.Customers.FindAsync(id);
    }

    public async Task<IEnumerable<Domain.Customer.Models.Queries.Customer>> GetAllAsync()
    {
        return await _makiContext.Customers.ToListAsync();
    }

    public async Task<bool> UpdateAsync(Domain.Customer.Models.Queries.Customer customer)
    {
